...
DROP TABLE QUESTION_FILE_ATTACH;
DROP TABLE ANSWER;
DROP TABLE QUESTION;
DROP TABLE REVIEW;
...
(
    ...
    MEMBER_SESSION_ID VARCHAR2(50 BYTE),
    MEMBER_SESSION_LIMIT DATE
);
...
(
    ...
    TEACGER_SUBJECT VARCHAR2(100 BYTE) NOT NULL
);
...
(
    ...
    CLASS_TIME VARCHAR2(2 BYTE) NOT NULL
);
...
(
    ...
    TICKET_SUBJECT VARCHAR2(100 BYTE) NOT NULL UNIQUE,
...
-- QNA 파일첨부
CREATE TABLE QUESTION_FILE_ATTACH
(
    QUESTION_FILE_ATTACH_NO NUMBER NOT NULL PRIMARY KEY,
    QUESTION_NO NUMBER NOT NULL,
    QUESTION_FILE_ATTACH_PATH VARCHAR2(300 BYTE),
    QUESTION_FILE_ATTACH_ORIGIN VARCHAR2(300 BYTE),
    QUESTION_FILE_ATTACH_SAVED VARCHAR2(40 BYTE)
);
...
ALTER TABLE QUESTION_FILE_ATTACH
    ADD CONSTRAINT QUESTION_FILE_ATTACH_FK FOREIGN KEY (QUESTION_NO)
        REFERENCES QUESTION (QUESTION_NO)
            ON DELETE CASCADE;
...
DROP SEQUENCE QUESTION_FILE_ATTACH_SEQ;
...
CREATE SEQUENCE QUESTION_FILE_ATTACH_SEQ NOCACHE;
