...
<script>
	...
	function fnGetClassList(){
		$('body').on('click', '.fc-day', function(ev){
			...
			window.open("${contextPath}/reserve/reserveDancePage?subject=DANCE&classDate=" + strDate, '', 'status=no, height=300, width=600, left='+ popupX + ', top='+ popupY + ', scrollbars=yes,resizable=yes');
		})
...
<body>
	...
	<div id="wrapper">
		<div id="title">
			...
			<div id="titleName">SPORT DANCE</div>
		</div>		
		<div id="calendar"></div>	
	</div>
