        ...
        <div class="container">
        	<div class="content">
				...
				<form id="f" action="${contextPath}/member/signUpPage">
					...
					<div class="text_box">
						<textarea rows="8" cols="70" spellcheck="false" readonly> 개인정보보호법에 따라 GymGoodee에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
					...
					<div class="text_box">
						<textarea rows="8" cols="70" spellcheck="false" readonly> 위치기반서비스 이용약관에 동의하시면, 위치를 활용한 GymGoodee 위치기반 서비스를 이용할 수 있습니다.
					...
					<div class="text_box">
						<textarea rows="3" cols="70" spellcheck="false"  readonly> GymGoodee에서 제공하는 이벤트/혜택 등 다양한 정보를 휴대전화, 이메일로 받아보실 수 있습니다.</textarea>
					</div>
					<br><br>
					
					<div class="btn_Area">
						<input type="button" value="취소" id="btnBack" class="btn_type">
						<button class="btn_type">다음</button>
					</div>
